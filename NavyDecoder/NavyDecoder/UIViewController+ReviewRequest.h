//
// UIViewController+ReviewRequest.h
// NavyDecoder-iOS
//
...
/// Thin adapter that forwards to ReviewManager (Swift) without exposing
/// NavyDecoder-Swift.h to callers that also import the Core Data Category class.
@interface UIViewController (ReviewRequest)
