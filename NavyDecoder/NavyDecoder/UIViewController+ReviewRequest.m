//
// UIViewController+ReviewRequest.m
// NavyDecoder-iOS
//
...
#import "NavyDecoder-Swift.h"

@implementation UIViewController (ReviewRequest)

- (void)requestReviewIfAppropriate {
    [ReviewManager requestReviewIfAppropriateIn:self.view.window.windowScene];
}
